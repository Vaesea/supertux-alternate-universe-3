...
class Capto final : public Boss
{
public:
  Capto(const ReaderMapping& mapping);
  ...
  static std::string class_name() { return "capto"; }
  virtual std::string get_class_name() const override { return class_name(); }
  static std::string display_name() { return _("Capto"); }
  virtual std::string get_display_name() const override { return display_name(); }
  virtual GameObjectClasses get_class_types() const override { return Boss::get_class_types().add(typeid(Capto)); }
...
private:
  ...
  public:
    ...
    virtual GameObjectClasses get_class_types() const override { return BadGuy::get_class_types().add(typeid(Capto::SnowExplosionParticle)); }
  };

private:
  Capto(const Capto&) = delete;
  Capto& operator=(const Capto&) = delete;
};
